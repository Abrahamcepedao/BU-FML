#This code shows how beta0 and beta1 are estimated (what does the loss function look like?)
...
# let us put a label on each point
...
# Now we calculate the error value for 300 different beta1 from -100 to 100. 

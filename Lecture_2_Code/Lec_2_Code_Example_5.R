...
# Some good references to read about it 
...
#Skew is approx 3*(mean-median)/sd

# KURTOSIS
# Kurtosis measures the weight of the "tails" relative to a standard normal distribution. Bigger tails = smaller kurtosis
# Indirectly assesses the sharpness of the central peak
# Think of kurtosis as "chance for outliers" - sharp peak has longer tails so higher chance for outliers

#But this is NOT the primary purpose of Kurtosis: https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4321753/

#Value for a normal distribution = 3
#
/
...
uniformData = runif(5000,min=0,max=1000)

#Uniform distribution is symmetric but tails are equal to center
hist(uniformData)

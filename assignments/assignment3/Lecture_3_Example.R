#This script illustrates the one-sample z-test
...
# been successful to help their clients lose weight. To assess this, they took a sample of
...
# This is a small P-value. Thus we have strong evidence against the null hypothesis. 
...
one.sample.z(null.mu = 15, xbar = 16.4,sigma=6.2,n=50)

...
# t test with R  a one-sided example
...
# It is a good idea to put the results in a variable 
results<-t.test(shark_len, mu=20, alternative="greater")

# You can use the "names" function to get the fields in the "results" variable
names(results)
